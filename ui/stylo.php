...
<body>
    ...
    <div id="top-nav-bar-container">
        <nav id="top-nav">
            ...
            <a href="http://localhost:32771/app/kibana">Kibana</a>
    ...
    <div id="main-body">
        ...
        <!-- TODO: Make comparison text section reactive, as stylo now supports all n-grams. -->

        <form id="styloform" method="post" action="stylo.php">
            <label for="ctrl-text">Enter a control text block:</label>
            <textarea rows="10" form="styloform" name="ctrl" id="ctrl"></textarea>

            <label for="comparison-texts">Enter up to three comparison text blocks:</label>
            <textarea rows="10" form="styloform" name="comp1" id="comp1"></textarea>
            <textarea rows="10" form="styloform" name="comp2" id="comp2"></textarea>
            <textarea rows="10" form="styloform" name="comp3" id="comp3"></textarea>

            <label for="analysis-type">Type of analysis to perform?</label>
            <input type="radio" value="stylokey" name="analysis">Keyword<br/>
            <input type="radio" value="stylounigram" name="analysis">N-gram<br/>
